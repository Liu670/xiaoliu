					...
					<div class="main-text-box-bbg">
						<div class="article-box">
							...
							<div class="article-content">
								<span class="article-summary"><b>摘要：</b>本课程以真实项目贯穿讲解，内容涉及Java
									Web环境搭建、JSP基础语法、JavaBean编程、JDBC、Servlet、过滤器与监听器、MVC，理论结合实践，边讲边练，穿插学习方法传授，真正实现Java程序从控制台到B/S结构程序的完美蜕变</span>
								<p>
									各位小伙伴们~又到了一年中，自我充电的黄金期，那么好消息来了，课工场即将开启大型限时活动【0元学习璇女神Java课程】。课程价值399元，开课后即返现金399元，是现金的现哦~<br />
									活动流程与返现规则<br />
									1、在腾讯课堂中点击购买课程：https://ke.qq.com/course/128564#term_id=100142816
									<br /> 2、完成付款后请与我们的咨询老师联系：QQ1: 2518311508 QQ2: 2165881978
									告知个人返现信息姓名及银行卡卡号<br /> 3、根据腾讯课堂规定，返现时间最晚是在课程结束后15个工作日内，请大家注意查收<br />
									4、课程开课后与咨询老师联系，提供课工场账号（没有课工场账号的童鞋，快快去注册），即可为你开通免费观看价值500元的回放视频哦~
								</P>
							</div>
							<div class="comment">
								<dl>
									...
									<dd class="comment-body">课工场，棒棒哒！</dd>
								</dl>
								<dl>
									<dt class="comment-top">
										<span class="fr">2011-09-25 13:33:55</span> <b>2楼</b> <b>拉娜</b>
									</dt>
									<dd class="comment-body">kgc,Fighting！</dd>
								</dl>
							</div>
